  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.section, {height: 100}]}>
        <TouchableOpacity
          ...
          <Image
            ...
            source={{
              uri: 'https://cdnuploads.aa.com.tr/uploads/Contents/2020/05/21/thumbs_b_c_734048bfd3b897e3a838fe7dbe4d2bcb.jpg?v=144915',
            }}
          />
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Image
            style={styles.deliveryImgWrapper}
            source={{
              uri: 'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/042018/untitled-1_102.png?5lnaGj371nVr0mbE.uvCG3dfRcjQIgZL&itok=f3Iwenu5',
            }}
          />
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Image
            style={styles.deliveryImgWrapper}
            source={{
              uri: 'https://www.albawaba.com/sites/default/files/styles/d08_standard/public/im/pr_new/DHL-large.png?itok=i3KT2eS2',
            }}
          />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.price}>${deliveryMethod.deliveryMethodCost}</Text>
      </View>
